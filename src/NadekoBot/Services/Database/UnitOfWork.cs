...
namespace NadekoBot.Services.Database
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        private ISelfAssignedRanksRepository _selfAssignedRanks;
        public ISelfAssignedRanksRepository SelfAssignedRanks => _selfAssignedRanks ?? (_selfAssignedRanks = new SelfAssignedRanksRepository(_context));
